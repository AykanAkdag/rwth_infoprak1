...
public:
     ...
     * @param map Map to add the streets and cities to.
     * @param path_to_city_file Path of the file that contains the informations about the cities
    ...
    //std::vector<City*> new_cities, std::vector<Street*> new_streets);
private:
